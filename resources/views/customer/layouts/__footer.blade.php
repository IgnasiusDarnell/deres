                ...
                <div class="col-lg-6">
                    <div class="d-flex justify-content-end pt-3">
                        ...
                        <a class="btn btn-outline-secondary btn-md-square rounded-circle"
                            href="https://id.linkedin.com/company/codepolitan"><i class="fab fa-linkedin-in"></i></a>
                    </div>
                </div>
            </div>
        </div>
        <div class="row g-5">
            <div class="col-lg-4 col-md-6">
                <div class="footer-item">
                    ...
                    <p class="mb-4">Kami menghadirkan kemudahan, pilihan menu terbaik, dan layanan cepat yang membuat
                        pengalaman kuliner Anda lebih menyenangkan!</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="footer-item">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                <span class="text-light"><a href="#"><i class="fas fa-copyright text-light me-2"></i>Restoranku</a>
